...
def read_matrix():
    ...
    try:
        ...
        return None
    """
    ### TRATANDO PARA PEDIR VALOR ATÉ FORNECER SEM ERRO E TAMBEM PARA EVITAR VALOR MENOR IGUAL A 0 NO NUMERO DE LINHAS E COLUNAS
    while True:
        try:
            rows = int(input("Enter the number of rows: "))
            cols = int(input("Enter the number of columns: "))
            ...
            if rows <= 0 or cols <= 0:
                print("Linhas e Colunas devem ser maior que 0.")
                continue
